...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      ...
      integer, allocatable :: peratesc(:),kuiper_res(:),oeratesc(:)
      ...
      integer :: eratesum,peratesum,peratesummc
      ...
      character(len=10) :: onumc,pnumc,pnummcc,buffer,simyr
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      ...
      datamcpdfs=.false.                                                        ! Data and MC PDFs
      ppdfmcpdfs=.true.                                                         ! Full predicted PDF and MC PDFs
      !--- Which PDFs would you like output? ----------------------------------!
      opdf_out=.false.                                                          ! Data PDF
