...
- **Value b**: Predicted age file format. Type: ``int``
    ...
    Value b = ``1``: ``Comparison.txt`` file generated by `HUGG version of Pecube <https://github.com/HUGG/Pecube-HUGG>`_. Complete this line with the following values:
    ...
    Value b = ``2``: Generic CSV file. Complete this line with the following values:
